...
Given **1 million riders** and **1 million drivers** uniformly distributed in a 1000×1000 unit world, the goal is to assign each rider to the **nearest available driver** while guaranteeing **no double‑booking**.
